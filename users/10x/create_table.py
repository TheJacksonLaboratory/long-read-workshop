...
df['Terminal'] = df["IP"].map(lambda beta_value: "<a href='http://{}:8888/terminals/1' target='_blank'>terminal</a>".format(beta_value))
df['Loupe'] = df["IP"].map(lambda beta_value: "<a href='http://{}:3000' target='_blank'>loupe</a>".format(beta_value))
