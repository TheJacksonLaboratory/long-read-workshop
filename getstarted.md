...
![terminal icon](https://github.com/snamburi3/workshop/blob/gh-pages/img/terminal.png)
...
![Putty Image](https://github.com/snamburi3/workshop/blob/gh-pages/img/putty_screenshot_1.png)
2. Click 'Open' and you will be presented with a security warning. Select 'Yes' to continue to connect. <br>
![Putty security screen](https://github.com/snamburi3/workshop/blob/gh-pages/img/putty_screenshot_2.png)
...
![Putty login](https://github.com/snamburi3/workshop/blob/gh-pages/img/putty_screenshot_3.png)
4. You should now be connected!
